...
def main():
    ...
    threshold = 10
    scaling_factor = 0.01
    create_mask(tif_5070_path, mask_5070, threshold)
    transform_5070_to_4326(mask_5070, mask_4326)
    rescale_resolution(mask_4326, mask_4326_lowres, scaling_factor)
    convert_to_geochem_nc(mask_4326_lowres, f_plya_nc, template_ds)
